...
test('KeeJef in Poweruser Feedback SOGS', () => {
  expect(
    blindSessionId({
      ...
      serverPk: '39016f991400c35a46e11e06cb2a64d6d8ab6652e484a556b14f7cf57ed7e73a'
    })
...
test('KeeJef in Session SOGS', () => {
  expect(
    blindSessionId({
      sessionId: '05d871fc80ca007eed9b2f4df72853e2a2d5465a92fcb1889fb5c84aa2833b3b40', 
      serverPk: 'a03c383cf63c3c4efe67acc52112a6dd734b3a946b9545f488aaa93da7991238'
    })
...
test('Ivan in Russian SOGS', () => {
  expect(
    blindSessionId({
      ...
      serverPk: '118df8c6c471ac0468c7c77e1cdc12f24a139ee8a07c6e3bf4e7855640dad821'
    })
...
test('hloth in custom SOGS 2', () => {
  expect(
    blindSessionId({
      sessionId: '057aeb66e45660c3bdfb7c62706f6440226af43ec13f3b6f899c1dd4db1b8fce5b', 
      serverPk: 'ac9c872e525a58970df6971655abb944a30b38853442a793b29843d20795e840'
    })
